...
import { LOGO_CHIP_BG } from '../lib/utils';
    ...
    return (
      <div className="w-full text-left p-5 rounded-2xl border-2 border-dashed border-line bg-surface-1 opacity-60 select-none relative overflow-hidden flex-1">
        <div className="flex items-center gap-4">
          <div className={`w-12 h-12 rounded-xl ${LOGO_CHIP_BG} border border-line flex items-center justify-center flex-shrink-0 overflow-hidden p-2.5`}>
            <img
