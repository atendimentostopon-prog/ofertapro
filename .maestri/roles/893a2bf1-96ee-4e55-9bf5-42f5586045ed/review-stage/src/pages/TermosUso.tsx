...
const TermosUso: React.FC = () => {
  useEffect(() => {
    document.title = `Termos de Uso | ${APP_NAME}`;
  }, []);
    ...
    <div className="min-h-screen bg-surface-1 text-ink py-16 px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        <div className="bg-surface-0/60 backdrop-blur-xl border border-line rounded-3xl p-8 sm:p-12 space-y-6 shadow-2xl">
          <div>
            <h1 className="text-3xl font-black text-ink tracking-tight mb-2">Termos de Uso</h1>
          ...
          <div className="space-y-6 text-sm text-ink-secondary leading-relaxed">
            <section className="space-y-3">
              <h2 className="text-base font-extrabold text-ink">1. Relação Contratual</h2>
              <p>
                Bem-vindo ao <strong>{APP_NAME}</strong>. Ao se cadastrar ou utilizar nossa plataforma, você concorda expressamente em cumprir e vincular-se a estes Termos de Uso. Caso não concorde com qualquer termo estabelecido, você não deverá acessar ou utilizar nossos serviços.
              </p>
            </section>

            <section className="space-y-3">
              <h2 className="text-base font-extrabold text-ink">2. Elegibilidade e Cadastro de Conta</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-base font-extrabold text-ink">3. Regras de Conduta e Uso Aceitável</h2>
              <p>
                O usuário compromete-se a usar o {APP_NAME} de boa-fé. É expressamente vedado:
              </p>
            ...
            <section className="space-y-3">
              <h2 className="text-base font-extrabold text-ink">7. Suspensão ou Encerramento de Conta</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-base font-extrabold text-ink">8. Modificações dos Termos</h2>
              <p>
                Podemos modificar estes termos a qualquer momento para refletir mudanças operacionais, regulatórias ou de segurança. Ao continuar a usar o {APP_NAME} após a data das atualizações, você aceita implicitamente as novas regras contratuais.
              </p>
            </section>
          </div>
        </div>
