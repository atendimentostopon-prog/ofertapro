    ...
    <div className="min-h-screen bg-surface-1 text-ink py-16 px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        <div className="bg-surface-0/60 backdrop-blur-xl border border-line rounded-3xl p-8 sm:p-12 space-y-6 shadow-2xl">
          <div>
            <h1 className="text-3xl font-black text-ink-inverse tracking-tight mb-2">Política de Cookies</h1>
          ...
          <div className="space-y-6 text-sm text-ink-secondary leading-relaxed">
            <section className="space-y-3">
              <h2 className="text-base font-extrabold text-ink-inverse">1. O que são Cookies?</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-base font-extrabold text-ink-inverse">2. Como Utilizamos os Cookies?</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-base font-extrabold text-ink-inverse">3. Categorias de Cookies Usados</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-base font-extrabold text-ink-inverse">4. Cookies de Terceiros</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-base font-extrabold text-ink-inverse">5. Como Gerenciar Seus Cookies</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-base font-extrabold text-ink-inverse">6. Alterações nesta Política</h2>
              <p>
