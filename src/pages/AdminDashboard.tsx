    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-line pb-5">
        <div>
          ...
          <h1 className="text-2xl font-extrabold text-ink tracking-tight mt-1 font-display">Painel Administrativo</h1>
          <p className="text-xs text-ink-secondary font-medium mt-0.5">Visão consolidada e controle operacional do SaaS {APP_NAME}</p>
        </div>
