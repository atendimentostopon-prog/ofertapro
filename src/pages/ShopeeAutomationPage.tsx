...
export const ShopeeAutomationPage: React.FC = () => {
  useEffect(() => {
    document.title = `Como solicitar a API da Shopee | ${APP_NAME}`;

    // Configuração de meta description para SEO
    const metaDescription = document.querySelector('meta[name="description"]');
    const descriptionText = `Veja o tutorial completo e passo a passo de como solicitar e cadastrar suas credenciais da API Shopee Affiliate no ${APP_NAME}.`;
    if (metaDescription) {
  ...
  const steps = [
    ...
    },
    {
      ...
      note: `Pronto! Suas credenciais estarão salvas com segurança no ${APP_NAME} e prontas para rodar integrações automatizadas.`,
      image: '/shopee-guide/step4.png',
      caption: `Seção de preenchimento das credenciais Shopee Affiliate dentro do painel do ${APP_NAME}.`,
      buttonLabel: null,
      url: null
    }
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: `Não. Para que a automação e integração de links da Shopee funcionem de forma direta no ${APP_NAME}, você precisa obrigatoriamente preencher credenciais válidas e aprovadas pela plataforma.`
    }
  ];
      ...
      <div className="max-w-4xl mx-auto relative z-10 space-y-12">
        ...
        <div className="flex items-center justify-between pb-6 border-b border-white/[0.06] select-none">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-sm font-extrabold text-white tracking-tight">Central de Ajuda · {APP_NAME}</span>
          </div>
        </div>
        ...
        <section className="text-center space-y-6 py-4">
          ...
          <p className="text-sm sm:text-base text-[#94A3B8] leading-relaxed max-w-xl mx-auto font-medium">
            Siga este passo a passo para solicitar acesso à API da Shopee Affiliate e depois cadastrar seu App ID e Secret Key no {APP_NAME}.
          </p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-xs sm:text-sm text-[#E2E8F0] leading-relaxed font-medium list-disc list-inside">
                <li>Este processo é necessário para quem deseja usar a automação da Shopee no {APP_NAME}.</li>
        ...
        <section className="glass-card border-white/[0.04] p-6 sm:p-8 space-y-4">
          ...
          <div className="space-y-3 text-xs sm:text-sm text-[#94A3B8] leading-relaxed font-medium">
            <p>
              Após cadastrar as credenciais da Shopee Affiliate corretamente nas suas configurações, o {APP_NAME} passará a utilizar a integração direta para automatizar e otimizar a substituição e o processamento de links da plataforma Shopee conforme as definições habilitadas no seu painel.
            </p>
            <p>
