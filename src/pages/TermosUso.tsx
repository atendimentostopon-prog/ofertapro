    ...
    <div className="min-h-screen bg-surface-1 text-ink py-16 px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        <div className="bg-surface-0/60 backdrop-blur-xl border border-line rounded-3xl p-8 sm:p-12 space-y-6 shadow-2xl">
          <div>
            <h1 className="text-3xl font-black text-ink-inverse tracking-tight mb-2">Termos de Uso</h1>
          ...
          <div className="space-y-6 text-sm text-ink-secondary leading-relaxed">
            <section className="space-y-3">
              <h2 className="text-base font-extrabold text-ink-inverse">1. Relação Contratual</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-base font-extrabold text-ink-inverse">2. Elegibilidade e Cadastro de Conta</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-base font-extrabold text-ink-inverse">3. Regras de Conduta e Uso Aceitável</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-base font-extrabold text-ink-inverse">4. Propriedade Intelectual</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-base font-extrabold text-ink-inverse">5. Limitação de Responsabilidade</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-base font-extrabold text-ink-inverse">6. Versão Beta e Disponibilidade</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-base font-extrabold text-ink-inverse">7. Suspensão ou Encerramento de Conta</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-base font-extrabold text-ink-inverse">8. Modificações dos Termos</h2>
              <p>
