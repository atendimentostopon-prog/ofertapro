...
const Layout: React.FC<LayoutProps> = ({ children, onLogout }) => {
  ...
  return (
    <div className="h-dvh overflow-hidden bg-surface-1 flex text-ink relative">
        ...
        <div className="fixed top-0 left-0 right-0 lg:left-64 z-[45] bg-danger-bg border-b border-danger/25 shadow-sm">
          <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-0.5 px-4 py-2.5 text-xs">
            <span className="text-center font-semibold text-danger-ink">
              Seu acesso terminou. Seus dados continuam salvos.
            </span>
            <button
      ...
      <div
        className={`flex-1 min-w-0 lg:ml-64 flex flex-col min-h-0 relative z-10 ${
      ...
      >
        ...
        <main className="flex-1 min-w-0 min-h-0 p-4 pb-24 md:p-6 overflow-y-auto"><div className="mx-auto w-full max-w-7xl">{children}</div></main>
      </div>
