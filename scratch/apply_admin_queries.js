...
const queries = [
  ...
  // 3. Função is_current_user_admin
...
queries.forEach((query, index) => {
  try {
    ...
    // Não encerra o processo para que outras queries possam tentar rodar se forem independentes
  }
});
